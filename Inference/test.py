...
class AccelerateOffloadInference:
    ...
    def load_model(self):
        ...
        if torch.cuda.is_available():
            ...
            max_gpu_memory = f"{max(1, int(gpu_memory * 0.8))}GB"  # Use 80% of GPU memory
        else:
            max_gpu_memory = "0GB"
        ...
        #     trust_remote_code=True,
        #     device_map="auto",
        #     max_memory={0: max_gpu_memory, "cpu": "48GB"},
        #     offload_folder="/offload_nvm",  # Must be NVMe-backed
        #     offload_state_dict=True,        # Enable disk-based sharded weight loading
        #     low_cpu_mem_usage=True
        # )
...
def main():
    ...
    if USE_ACCELERATE:
        print("Using Accelerate library for smart offloading...")
    ...
    try:
        ...
        print("\n" + "="*60)
        print("Starting inference with smart CPU offloading...")
        print("="*60)
